...
def policial_sozinho():
    escolha2 = input('''
    Você chegou sozinho ao banco e viu que o assaltante tem cúmplices. O que você faz?
...
def policial_com_reforcos():
    ...
    Você e mais quatro companheiros chegam ao banco e veem que o bandido tem cúmplices. O que você faz?
...
def policial_chama_reforços():
    escolha3 = input('''
    Você ligou para a delegacia e chamou reforços. Mas, enquanto espera, percebeu que que um dos bandidos está vindo em sua direção. 
    O que você faz?
...
def policial_chama_atencao():
    ...
    A maioria deles vai até lá ver o que causou o barulho. Mas um segue na porta do banco. O que você faz?
...
def refem_pegando_terco():
    ...
    if escolha3 == "A":
        print('''
        Discretamente, você se abaixa de desamarra o segurança da agência, que estava no chão perto de você.
        O homem tem uma segunda arma escondida na perna e que não foi descoberta pelo bandido.
        Ele usa o elemento surpresa para neutralizar o ladrão e impedir o assalto.
        Parabéns, você ajudou a derrutar o criminoso e venceu o jogo.
        ''')
        fim_do_jogo()
    elif escolha3 == "B":
        print('''
...
def refem_mente():
    ...
    if escolha3 == "A":
        ...
        Quando o ladrão percebe, você já está fechando a sala atrás dele.
        Pouco depois, os policiais chegam e prendem o homem. 
...
def refem_derruba_casaco():
    ...
    if escolha3 == "A":
        ...
        O ladrão resolve fugir antes que a polícia chegue. Mas, com raiva, atira em você antes de sair.
        Você morreu.
        ''')
        fim_do_jogo()
    elif escolha3 == "B":
...
def bandido_ignora_movimento():
    ...
    Depois, pergunta alto quem é o gerente a agência.
...
def bandido_escolhe_funcionario():
    ...
    if escolha3 == "A":
        ...
        ('''
        Você vê um bebedor próximo e resolve pegar um copo de água para jogar na cara do homem.
